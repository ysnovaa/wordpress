 ...
 */
function simclick_jetpack_setup() {
	/**
	...
	if ( 'infinite-scroll' === $pagination_type ) {
		add_theme_support( 'infinite-scroll', array(
			...
			'render'    => 'simclick_infinite_scroll_render',
			'footer'    => 'page',
			'wrapper'   => false,
		) );
	}
...
add_action( 'after_setup_theme', 'simclick_jetpack_setup' );

/**
 * Custom render function for Infinite Scroll.
 */
function simclick_infinite_scroll_render() {
	while ( have_posts() ) {
		the_post();
		if ( is_search() ) :
